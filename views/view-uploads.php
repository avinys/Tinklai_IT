        ...
        <?php else: ?>
            <table class="table">
                ...
                <?php foreach ($uploads as $upload): ?>
                    <tr>
                        <td style="padding: 0; max-height:150px; max-width: 150px;"><img style="height: 100%; width: 100%; object-fit: contain;" src="<?= htmlspecialchars($upload['Nuotrauka']) ?>" alt="Nuotrauka" width="100" /></td>
